										...
										<div class="cart-list">
											<div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty"><?php echo $item["quantity"]; ?></span><?php echo "$ ".$item["price"]; ?></h4>
												</div>
...
// itt valami nagyon nem jó, az elnevezésekből most hirtelen nemtudom mit hagytam így itt, de ez még az előző tábla próba
?> 
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h4 class="product-price"><?php echo "$".$product_array[$key]["price"]; ?><del class="product-old-price">Ft990.00</del></h4>
