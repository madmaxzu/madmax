                                    ...
                                    <div class="cart-dropdown">
										...
										?>
                                            <div class="product-widget">
                                                ...
                                                <a href="bsales.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a>
                                            </div>
										<?php } ?>
</div>
...
?>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<form method="post" action="bsales.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">                                            <div class="cart-action">
